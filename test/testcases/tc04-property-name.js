...
export class ProductSalesInfoDao {
	...
	static async query(sql: string, params: any[], conn: Pick<Connection, 'execute'>, options?: {log?: LogFunction}): Promise<ProductSalesInfo[]>;
	static async query(sql: string, arg1: any, arg2: any, arg3?: any): Promise<ProductSalesInfo[]> {
